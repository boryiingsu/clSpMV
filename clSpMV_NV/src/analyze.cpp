...
bool extract_block(coo_matrix<int, float>& coomat, cocktail<int, int, float>& mat, maxflop_info& info, coo_matrix<int, float>& cooremain, benchmark_all& bench)
{
    printf("\n---------------------------------------------\n");
...
void analyze_matrix(coo_matrix<int, float>& coomat, cocktail<int, int, float>& mat)
{
    ...
    double dia_to_block_ratio = 1.05;
	...
	if (max_block_base > max_flat_base)
	{
		...
		if (coomat.matinfo.width == coomat.matinfo.height)
		{
		    ...
		    {
			starttime = timestamp();
			bool ifblock = extract_block(cooremain1, mat, info, cooremain2, bench);
			endtime = timestamp();
		    ...
		    {
			starttime = timestamp();
			bool ifblock = extract_block(coomat, mat, info, cooremain2, bench);
			endtime = timestamp();
			printf("Block category analysis time %lf s\n", endtime - starttime);
			starttime = timestamp();
			if (ifblock)
		...
		{
		    starttime = timestamp();
		    bool ifblock = extract_block(coomat, mat, info, cooremain1, bench);
		    endtime = timestamp();
		    printf("Block category analysis time %lf s\n", endtime - starttime);
		    starttime = timestamp();
		    if (ifblock)
